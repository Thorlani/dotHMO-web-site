import styles from "../../styles/advance.module.css";
        ...
        <div className={styles.container}>
            <div className={styles.heroSection}>
                <div className={styles.heroText}>
                    <h1 className={styles.h1}>Advanced Telemedicine</h1>
                ...
                <div className={styles.heroImage}>
                    <Image src="/advance.svg" width="500" height="500" />
                </div>
            </div>
